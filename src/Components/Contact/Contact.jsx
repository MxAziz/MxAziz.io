...
const Contact = () => {
  ...
  return (
    <div className=" pb-8">
      ...
      {/* email js */}
      <div className=" w-11/12 mx-auto flex flex-col lg:flex-row lg:items-center lg:justify-between">
        {/* left  */}
        ...
        {/* right */}
        <div className=" w-10/12 lg:w-1/2 mx-auto lg:mr-12 mt-8 lg:mt-0 ">
          <form
          ref={form}
          onSubmit={sendEmail}
